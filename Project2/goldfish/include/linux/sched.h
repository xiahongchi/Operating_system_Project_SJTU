...
#define RAS_FG_TIMESLICE		(50 * HZ / 1000)
#define RAS_BG_TIMESLICE		(30 * HZ / 1000)
#define RAS_INC_TIME 		(10 * HZ / 1000)
...
extern int sysctl_sched_ras_runtime;
